...
# Code adapted from https://github.com/georgeyiasemis/2D-Convolutional-Recurrent-Neural-Networks-with-PyTorch/blob/main/conv2d_rnncells.py
...
class Conv2dLSTMCell(nn.Module):
    def __init__(self, input_size, hidden_size, kernel_size, bias=True):
        ...
        self.Wc = nn.Parameter(torch.zeros((1, self.hidden_size * 3, 64, 64)))
    ...
    def set_weights(self, Wc):
        self.Wc = nn.Parameter(Wc)

    def forward(self, input, hx, cx):  # hx=None
